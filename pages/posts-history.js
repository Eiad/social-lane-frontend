      ...
      <div className="min-h-screen bg-gray-100 dark:bg-slate-900 text-gray-900 dark:text-white">
        ...
        <main className="container mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            {isScheduledPost ? (
                              <div className="flex items-center text-indigo-600">
                                ...
                                <span className="text-gray-600">{formatDateShort(post?.scheduledDate)}</span>
                              </div>
                            ) : (
            ...
            <div className="px-6 text-sm py-4 flex justify-between items-center border-t border-gray-200">
              <div className="flex space-x-2">
                <button
                ...
                <div className="flex items-center space-x-1 text-sm">
                  {[...Array(totalPages).keys()].map(i => (
                    <button
                      ...
                      className={`w-8 text-sm h-8 rounded-full flex items-center justify-center ${
                        currentPage === i + 1
                  ...
                  {totalPages > 5 && currentPage < totalPages - 2 && (
                    <>
                      ...
                      <button
                        ...
                        className="w-8 text-sm h-8 rounded-full flex items-center justify-center bg-white text-gray-700 hover:bg-gray-50"
                      >
                        {totalPages}
                      </button>
                    </>
              ...
              <div className="text-sm text-gray-500">
                {(() => {
                  ...
                  const endPost = Math.min(currentPage * postsPerPage, displayedTotalPosts);
                  const actualEndPost = Math.min(startPost + posts.length - 1, displayedTotalPosts);
                  
                  return (
                    <>
                      <span className="text-xs">Showing <span className="font-medium">{startPost}-{actualEndPost}</span> of <span className="font-medium">{displayedTotalPosts}</span> posts</span>
                    </>
                  );
                })()}
              </div>
