...
const Subscription = () => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
      {plans.map((plan, index) => {
        ...
        return (
          <div 
            key={plan.name}
            className={`relative bg-white text-gray-800 rounded-xl overflow-hidden shadow-lg ${
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-6 mb-8">
                <span className="text-5xl font-bold text-gray-900">${billingPeriod === 'monthly' ? plan.monthlyPrice : Math.round(plan.yearlyPrice / 12)}</span>
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
              <p className="text-gray-600 text-sm text-center">7 day money-back guarantee</p>
            </div>
          </div>
        );
      })}
  ...
  const renderSupportedPlatforms = () => (
    <div className="mt-16 text-center">
      <p className="text-gray-600 mb-4">Post to:</p>
      ...
      <div className="min-h-screen bg-gray-50 text-gray-800">
        <div className="pt-6 px-4 sm:px-6 transition-all duration-300">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl font-bold text-center text-gray-900 mb-8 mt-8">Choose your plan</h1>
            ...
            {loading ? (
              ...
              subscriptionStatus === 'loading' ? (
                ...
                <div>
                  ...
                  {subscriptionStatus === 'active' && subscriptionDetails && (
                    <div className="mt-16 bg-white rounded-xl p-6 max-w-2xl mx-auto shadow-lg border border-gray-200">
                      <h2 className="text-2xl font-bold text-gray-900 mb-4">Your Active Subscription</h2>
                      <div className="bg-gray-100 p-4 rounded-lg mb-4">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-700">Status:</span>
                          <span className="text-green-500 font-medium">{subscriptionDetails?.status}</span>
                        </div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-700">Plan:</span>
                          <span className="text-gray-900 font-medium">{subscriptionDetails?.planTier || subscriptionDetails?.role}</span>
                        </div>
                        {subscriptionDetails?.nextBillingTime && (
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-gray-700">Next Billing:</span>
                            <span className="text-gray-900">{formatDate(subscriptionDetails?.nextBillingTime)}</span>
                          </div>
                        )}
                      </div>
                  ...
                  {subscriptionStatus === 'error' && (
                    <div className="mt-8 bg-red-50 border border-red-300 p-4 rounded-lg max-w-2xl mx-auto">
                      <h3 className="text-xl font-semibold text-red-700 mb-2">Subscription Error</h3>
                      <p className="text-red-600 mb-4">{error || 'There was an error processing your subscription.'}</p>
                      <button
              ...
              <div className="bg-white rounded-xl p-8 shadow-xl max-w-md mx-auto text-center transition-all duration-300 animate-scale-in border border-gray-200">
